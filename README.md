...
For each browser, HistoryLogger, will create a log file located in (64-bit) C:\Program Files\PovlTekstTV\HistoryLogger\Logs. The files are named: chrome_log.txt, firefox_log.txt, and edge_log.txt. An example of one of these files is shown below: (First line is a full google search normally encrypted)
